...
import { User, Lock, AlertCircle, Eye, EyeOff, CheckCircle, X, Mail } from 'lucide-react';
...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async () => {
    // Block multiple requests using both ref and state
    ...
    try {
      // API call using fetch (replace with axios if preferred)
      ...
      console.log('Signup request completed/failed - ready for new requests');
    }
  };
      ...
      <div className="w-1/2 flex flex-col justify-center items-center lg:items-start p-8 lg:p-16 text-center lg:text-left">
        <div className="max-w-md">
          ...
          <p className="text-lg text-slate-300 font-light">
            Create your account and start managing payments effortlessly
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-10">
            ...
            <div className="space-y-6">
              {/* First Name Field */}
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="firstName">
                  First Name
                </label>
              ...
              {/* Last Name Field */}
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="lastName">
                  Last Name
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
